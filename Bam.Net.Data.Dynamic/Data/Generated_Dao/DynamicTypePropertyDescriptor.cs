...
namespace Bam.Net.Data.Dynamic.Data.Dao
{
	...
	// property:DynamicTypeId, columnName:DynamicTypeId	
	[Bam.Net.Data.Column(Name="DynamicTypeId", DbDataType="BigInt", MaxLength="19", AllowNull=true)]
	public long? DynamicTypeId
	{
		get
		{
			return GetLongValue("DynamicTypeId");
		}
		set
		{
			SetValue("DynamicTypeId", value);
		}
	}
